...
export default function Hero() {
  return (
    <section className="relative w-full h-[15rem] sm:h-[25rem] md:h-[35rem] lg:h-[40rem] xl:h-[45rem] 2xl:h-[54rem]  hero-large flex items-center justify-center overflow-hidden absolute md:top-[150px] top-[125px]">
      {/* Background Image */}
      <Image
        src={HeroImg}
        alt="Hero background"
